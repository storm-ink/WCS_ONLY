...
namespace Wcs.Framework
{
    ...
    /// 默认的逻辑动作选择器
    /// </summary>
    public sealed class DefaultLogicMovementSelector:LogicMovementSelector
    {
        /// <summary>
        /// 老框架支持的创建逻辑动作方法
        /// </summary>
        ...
        public override LogicMovement ToLogicMovement(RouteHead route, Task task, Location start, Location end)
        {
            ...
            TcpProtocolTaskableDevice device = DeviceConverter.ToDevice<TcpProtocolTaskableDevice>(route.Device);
