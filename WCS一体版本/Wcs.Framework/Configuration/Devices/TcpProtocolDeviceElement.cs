...
{
    public abstract class TcpProtocolDeviceElement:DeviceElement
    {
        /// <summary>
        /// 表示网络端点的IP 地址和端口号
        /// </summary>
        ...
        public TcpProtocolDeviceElement(XmlNode node, WcsConfiguration configuration)
        ...
        /// </summary>
        /// <param name="node">配置节点</param>
        public TcpProtocolDeviceElement(XmlNode node, WcsConfiguration configuration, Boolean deserialize)
            : base(node,configuration,false)
        {
            ...
            this.SendTimeout = GetAttributeOrDefault<Int32>("sendTimeout", 2000);
            ...
            if (this.DataReceiver is ThreadRunningLog _dataReceiver)
                _dataReceiver.Init(this.DataReceiver.DeviceName + "_" + this.DataReceiver.Name);
