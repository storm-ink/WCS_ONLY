...
{
    class TaskSourceIsUnKnownCompeletedHandlerElement : ConfigurationElement
    {
        ...
        public TaskSourceIsUnKnownCompeletedHandlerElement(XmlNode node, WcsConfiguration configuration)
