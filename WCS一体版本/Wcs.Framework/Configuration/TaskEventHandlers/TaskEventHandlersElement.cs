...
{
    public class TaskEventHandlersElement:ConfigurationElement
    {
        public TaskRunningEventHandler TaskRunningEventHandlerProxy { get; private set; }
        public TaskCompletedEventHandler TaskCompletedEventHandlerProxy { get; private set; }
        public TaskErrorEventHandler TaskErrorEventHandlerProxy { get; private set; }
        public TaskRequestEventHandler TaskRequestEventHandlerProxy { get; private set; }
        public TaskCurrentLocationChangedEventHandler TaskCurrentLocationChangedEventHandlerProxy { get; private set; }
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="node">配置节点</param>
        public TaskEventHandlersElement(XmlNode node, WcsConfiguration configuration)
            : base(node,configuration, false)
        {
            TaskRunningEventHandlerProxy = new TaskRunningEventHandler();
            TaskCompletedEventHandlerProxy = new TaskCompletedEventHandler();
            TaskErrorEventHandlerProxy = new TaskErrorEventHandler();
            TaskRequestEventHandlerProxy = new TaskRequestEventHandler();
            TaskCurrentLocationChangedEventHandlerProxy = new TaskCurrentLocationChangedEventHandler();
        ...
        protected override void Deserialize()
        {
            ...
            applyHandles(TaskCurrentLocationChangedEventHandlerProxy, "onCurrentLocationChanged");
            ...
            foreach (var device in taskableDevices)
            {
                ...
                device.TaskCurrentLocationChanged += this.TaskCurrentLocationChangedEventHandlerProxy.Handle;
            }
        }

        void applyHandles<TArgs>(TaskEventHandler<TArgs> handlers, String handlersNodeName)
