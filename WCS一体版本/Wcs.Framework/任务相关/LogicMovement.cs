...
namespace Wcs.Framework
{
    ...
    {
        Iesi.Collections.Generic.ISet<EquipmentAction> _equipmentActions = new Iesi.Collections.Generic.HashedSet<EquipmentAction>();
        protected LogicMovement()
        {
        }
        public LogicMovement(Device device, Int32? routeId, Location startLocation, Location endLocation)
        {
            this.RouteId = routeId;
            this.DeviceName = device.Name;
            this.StartLocation = new LocationInfo(device.Name, startLocation.DeviceCode, startLocation.UserCode);
            this.EndLocation = new LocationInfo(device.Name, endLocation.DeviceCode, endLocation.UserCode);
