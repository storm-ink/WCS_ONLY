...
namespace Wcs.DefaultImplementCollection.AGV
{
    ...
    public class AGVSubSystemLocation:Wcs.Framework.Location
    {
        ...
        public AGVSubSystemLocation(SinevaAGVDevice device, String deviceCode, String userCode, string stationNo, int position_x, int position_y, UInt32 position_angle, int level)
