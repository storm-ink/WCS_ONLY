    ...
    public class AGVSubSystemLocationElement:LocationElement
    {
        ...
        protected override Wcs.Framework.Location CreateLocation()
        {
            ...
            if (!this.IsWildcard)
            {
                ...
                loc = new AGVSubSystemLocation((SinevaAGVDevice)device, DeviceCode, UserCode, StationNo, Position_X, Position_Y, Position_Angle, Level);
            }
            else
            {
                if (this.LocationType != null)
                ...
                {
                    loc = new AGVSubSystemLocationWildcard((SinevaAGVDevice)device, this);
                }
            }

            ((SinevaAGVDevice)device).AcceptLocation(loc);
        ...
        protected override void Deserialize()
        {
            if (!this.IsWildcard)
            {
                ...
                this.StationNo = GetAttribute<string>("stationNo");
