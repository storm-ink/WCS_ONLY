...
namespace Wcs.DefaultImplementCollection.Conveyor
{
    ...
    /// </summary>
    public class ConveyorLocationWildcard : ConveyorLocation, ILocationWildcard
    {
        public ConveyorLocationWildcard(Device device, bool ableAsOnlyLocation = false)
            : base(-1, null, device, false, false, false, false, false, null, device.Name)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            ConveyorDevice conveyorDevice = (ConveyorDevice)this.Device;

            return conveyorDevice.Locations
