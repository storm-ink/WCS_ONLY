...
namespace Wcs.DefaultImplementCollection.Robot
{
    ...
    /// 表示Robot调度的逻辑动作
    /// </summary>
    public class RobotTransferMovement : LogicMovement
    {
        protected RobotTransferMovement()
            : base()
        {
        }
        public RobotTransferMovement(TaskableDevice device, Int32 routeId, Location startLocation, Location endLocation, Int16 containerCode)
        ...
        protected override void CreateEquipmentActions()
        {
            ...
            RobotTransferAction action = new RobotTransferAction(
                robotDevice, 
                group,
                equipmentTaskId,
                this.RouteId.Value,
