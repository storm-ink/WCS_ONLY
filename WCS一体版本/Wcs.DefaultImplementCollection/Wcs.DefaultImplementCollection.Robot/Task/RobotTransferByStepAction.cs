...
namespace Wcs.DefaultImplementCollection.Robot
{
    ...
    /// 表示一个Robot调度的物理动作
    /// </summary>
    public class RobotTransferByStepAction : EquipmentAction
    {
        ...
        protected RobotTransferByStepAction()
            : base()
        {
        }
        public RobotTransferByStepAction(RobotDevice device, EquipmentActionGroup group, Int32 equipmentTaskId, Int32 routeId, RobotLocation startLocation, RobotLocation endLocation)
        ...
        {
            this.StateManager = AbstractStateManager.CreateOrGetContext<RobotByStepStateManager>(this, DeviceConverter.ToDevice<TaskableDevice>(this.DeviceName));

            return new AddAutomaticTransferWithStepByStepCommand();
        }
