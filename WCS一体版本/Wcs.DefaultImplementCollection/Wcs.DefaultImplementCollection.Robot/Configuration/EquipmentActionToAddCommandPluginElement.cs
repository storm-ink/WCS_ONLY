...
namespace Wcs.DefaultImplementCollection.Robot
{
    public class EquipmentActionToAddCommandPluginElement : ConfigurationElement
    {
        ...
        public RobotEquipmentActionToAddCommandPlugin EquipmentActionToAddCommandPlugin { get; private set; }
        ...
        {
            var typeName = GetAttributeOrDefault<String>("type", typeof(RobotEquipmentActionToAddCommandPlugin).FullName);
            ...
            if (!type.IsSubclassOf(typeof(RobotEquipmentActionToAddCommandPlugin)) && type != typeof(RobotEquipmentActionToAddCommandPlugin))
            {
                var path = this.Node.GetXPath();
        ...
        protected virtual RobotEquipmentActionToAddCommandPlugin CreatePlugin()
        {
            ...
            this.EquipmentActionToAddCommandPlugin = ReflectionHelper.CreateInstance<RobotEquipmentActionToAddCommandPlugin>(this.Type);
