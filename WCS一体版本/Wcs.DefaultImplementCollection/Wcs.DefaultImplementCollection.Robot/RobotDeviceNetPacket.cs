...
namespace Wcs.DefaultImplementCollection.Robot
{
    ...
    /// 数据包
    /// </summary>
    public class RobotDeviceNetPacket : NetPacket
    {
        ...
        byte[] _bytes;
        public RobotDeviceNetPacket()
        {

        }
        public RobotDeviceNetPacket(byte[] packageBytes)
        {
            try
            {
        ...
        public override NetPacket CreateNetPackage(byte[] dataPart)
        {
            ...
            return new RobotDeviceNetPacket(datagramBytes.ToArray());
        }
    }
}
