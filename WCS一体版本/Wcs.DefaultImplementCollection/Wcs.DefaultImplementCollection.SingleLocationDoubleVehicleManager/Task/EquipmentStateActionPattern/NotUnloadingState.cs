...
namespace Wcs.DefaultImplementCollection.SingleLocationDoubleVehicleManager
{
    ...
    {
        public NotUnloadingState(SingleLocationDoubleVehicleSubSystemEquipmentActionScheduler scheduler, StateManagerRestoreInfo context, EquipmentAction action)
        {
        ...
        void 行走到放货点()
        {
            ...
            WalkWithGoodsCommand cmd = new WalkWithGoodsCommand(
                String.Format("30{0:000000}", _action.EquipmentTaskId),
                Convert.ToUInt16(_action.ContainerCode),
                destinationLocation.StationNo);
