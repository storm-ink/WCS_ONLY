...
namespace Wcs.DefaultImplementCollection.SingleLocationDoubleVehicleManager
{
    ...
    /// 需要移动到目的点
    /// </summary>
    public class NotArriveToDestinationLocationState2 : AbstractState2
    {
        public NotArriveToDestinationLocationState2(SingleLocationDoubleVehicleSubSystemEquipmentActionScheduler2 scheduler, StateManagerRestoreInfo context, EquipmentAction action, LocationInfo location, string name)
        {
        ...
        public NotArriveToDestinationLocationState2(SingleLocationDoubleVehicleSubSystemEquipmentActionScheduler2 scheduler, string giveAwayVehicle, SingleLocationDoubleVehicleSubSystemLocation location)
        {
