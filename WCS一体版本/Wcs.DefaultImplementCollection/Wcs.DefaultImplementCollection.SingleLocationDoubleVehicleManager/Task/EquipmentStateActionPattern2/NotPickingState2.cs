...
namespace Wcs.DefaultImplementCollection.SingleLocationDoubleVehicleManager
{
    ...
    /// 未取货，等待取货
    /// </summary>
    public class NotPickingState2 : AbstractState2
    {
        public NotPickingState2(SingleLocationDoubleVehicleSubSystemEquipmentActionScheduler2 scheduler, StateManagerRestoreInfo context, EquipmentAction action)
        {
