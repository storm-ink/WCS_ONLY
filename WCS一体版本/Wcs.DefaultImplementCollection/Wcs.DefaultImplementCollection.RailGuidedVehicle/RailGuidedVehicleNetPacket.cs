...
namespace Wcs.DefaultImplementCollection.RailGuidedVehicle
{
    ...
    /// 定义该对象只为套用系统结构
    /// </summary>
    public class RailGuidedVehicleNetPacket:NetPacket
    {
        ...
        byte[] _bytes;
        public RailGuidedVehicleNetPacket()
        {

        }
        public RailGuidedVehicleNetPacket(byte[] packageBytes)
        {
        ...
        public override NetPacket CreateNetPackage(byte[] dataPart)
        {
            ...
            return new RailGuidedVehicleNetPacket(datagramBytes.ToArray());
        }
    }
}
