...
{
    public class YDCommandReplyTelexTransferObject : TelexTransferObject
    {
        public YDCommandReplyTelexTransferObject()
            : base()
        { }

        public YDCommandReplyTelexTransferObject(byte[] bytes)
        {
        ...
        public override string TypeFlag { get; set; } = "DY";
