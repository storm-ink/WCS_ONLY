...
{
    public class QHCommandReplyTelexTransferObject : TelexTransferObject
    {
        public QHCommandReplyTelexTransferObject()
            : base()
        { }

        public QHCommandReplyTelexTransferObject(byte[] bytes)
        {
        ...
        public override string TypeFlag { get; set; } = "HQ";
