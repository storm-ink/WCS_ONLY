...
{
    public class QXCommandReplyTelexTransferObject : TelexTransferObject
    {
        public QXCommandReplyTelexTransferObject()
            : base()
        { }

        public QXCommandReplyTelexTransferObject(byte[] bytes)
        {
        ...
        public override string TypeFlag { get; set; } = "XQ";
