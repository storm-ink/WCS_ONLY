...
{
    public class FHCommandReplyTelexTransferObject : TelexTransferObject
    {
        public FHCommandReplyTelexTransferObject()
            : base()
        { }

        public FHCommandReplyTelexTransferObject(byte[] bytes)
        {
        ...
        public override string TypeFlag { get; set; } = "HF";
