...
{
    public class ZHCommandReplyTelexTransferObject : TelexTransferObject
    {
        public ZHCommandReplyTelexTransferObject()
            : base()
        { }

        public ZHCommandReplyTelexTransferObject(byte[] bytes)
        {
        ...
        public override string TypeFlag { get; set; } = "HZ";
