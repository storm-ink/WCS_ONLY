...
namespace Wcs.DefaultImplementCollection.Crane_yc
{
    ...
    public class NotArriveToUnloadingLocationState : AbstractState
    {
        ...
        public override void Perform()
        {
            ...
            if (currentLocation == null)
                currentLocation = unloadingLocation;

            //this.StepSerialNo = "FZ" + this.Context.EquipmentAction.EquipmentTaskId.ToString("000000");
                this.StepSerialNo = "3" + this.Context.EquipmentAction.EquipmentTaskId.ToString("0000000");
            //if (craneDevice.LastStatus.TaskId == this.StepSerialNo)
            //    this.StepSerialNo = "33" + this.Context.EquipmentAction.EquipmentTaskId.ToString("000000");
