...
namespace Wcs.DefaultImplementCollection.Crane
{
    ...
    /// 默认的堆垛机状态数据对比器
    /// </summary>
    public class DefaultTcpCraneDataComparer : IDataComparer<NetTransferObject, CraneReportInfo>
    {
        ...
        CompareResult<NetTransferObject>[] IDataComparer<NetTransferObject, CraneReportInfo>.Compare(CraneReportInfo oldData, CraneReportInfo newData)
        {
