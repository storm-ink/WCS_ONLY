...
namespace Wcs.DefaultImplementCollection.Crane
{
    ...
    public class NotArriveToPickingLocationState : AbstractState
    {
        ...
        public override void Perform()
        {
            ...
            var cmd = new CraneCommand(CmdTypes.NewTask, CraneTaskTypes.StepWalk, null, (RackLocation)startLocation, equipmentTaskId, (UInt32)this.Context.EquipmentAction.EquipmentTaskId, barcode);
