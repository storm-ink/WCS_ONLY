...
{
    [WcsPluginInfo(typeof(HistoryWarningRecordPlugin), "当前报警", "Sineva", "2023年4月", "", false, "报警记录", "报警查询", 6, 0, 1)]
    public class WarningRecordPlugin : Wcs.WcsPlugin
    {
        ...
        [Wcs.Security.WcsPermission(System.Security.Permissions.SecurityAction.Demand, OperationName = "报警记录\\当前报警")]
        void tsmi_Click(object sender, EventArgs e)
        {
            try
            {
                this.Context.Application.MainForm.OpenNewForm<frmMain>("当前报警");
            }
