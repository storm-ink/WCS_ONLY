...
namespace BOE
{
    ...
    /// 自复位占位请求处理程序
    /// </summary>
    public class AutoClearHoldSingleRequestTaskStartUp_EmptyPallets_1005 : ThreadRunningLog, IApplicationStartup
    {
